...
public class EventDispatcher {
    ...
    /**
     * Static wrapper for INSTANCE.onEvent2()
     *
     * @param eventObj
     */
    public static void onEvent(Object eventObj) {
        INSTANCE.onEvent2(eventObj);
    }

    /**
     * Static wrapper for INSTANCE.subscribe2()
     *
     * @param obj
     */
    public static void subscribe(Object obj) {
        INSTANCE.subscribe2(obj);
    }
     ...
     **/
    private void onEvent2(Object obj) {
        if(subscribers.containsKey(obj.getClass())) {
            ...
            for (Pair<Object, List<Method>> pair : subscriberObjects)
                for (Method method : pair.getValue()) invoke(method, pair.getKey(), obj);
     ...
     * All method annotated with Subscribe will be added to the subscriber list.
     * @param obj - Object of the class that has the subscriber methods
     */
    private void subscribe2(Object obj) {
        Class cls;
        ...
        List<Method> methods = getMethods(Subscribe.class, cls.getMethods());
        ...
        List<Method> multiMethods = getMethods(MultiSubscribe.class, cls.getMethods());
